...
namespace UserRegistrationProblem
{
    ...
    {
        /// <summary>
        /// Method for Creating a Default Object of Validation class using reflection
        /// </summary>
        ...
        public object CreateValidationObject(string className, string constructor)
        {
            try
            {
                ...
                {
                    throw new InvalidException(InvalidException.ExceptionType.NULL_INPUT, "Class name or constructor name should not be null");
                }
                ...
                if (result.Success) // If class name matched with constructor name then 
                {
                    ...
                    {
                        throw new InvalidException(InvalidException.ExceptionType.CLASS_NOT_FOUND, "Class not found");
                    }
                }
                else // Constructor name not matched with class name then throw exception like constructor not found
                {
                    throw new InvalidException(InvalidException.ExceptionType.CONSTRUCTOR_NOT_FOUND, "Constructor not found");
                }
            }
        ...
        /// <summary>
        /// Method for Creating a Parameterized Object of Validation class using reflection
        /// </summary>
        /// <param name="className"></param>
        /// <param name="constructor"></param>
        ...
        public object CreateValidationParameterizedObject(string className, string constructor, string input)
        {
            try
            {
                ...
                {
                    throw new InvalidException(InvalidException.ExceptionType.NULL_INPUT, "Class name,constructor name or message should not be null");
                }
        ...
        /// <summary>
        /// Method for Invoking a method using reflection
        /// </summary>
        /// <param name="input"></param>
        /// <param name="methodName"></param>
        /// <returns></returns>
        /// <exception cref="InvalidException"></exception>
        public string InvokeMethod(string input, string methodName) 
        {
            try
            {
                ...
                object validationObject = CreateValidationParameterizedObject("UserRegistrationProblem.Validation", "Validation", input);//Creating a parameterized object of Validation class using reflection
            ...
            {
                throw new InvalidException(InvalidException.ExceptionType.METHOD_NOT_FOUND, "Method not found");
            }
        }
    }
}
